...
public class PostalCode {
    ...
    private Integer id;
    @Column(name = "d_codigo", nullable = false)
    private String d_codigo;
    @Column(name = "d_asenta", nullable = false)
    private String d_asenta;
    @Column(name = "d_tipo_asenta", nullable = true)
    private String d_tipo_asenta;
    @Column(name = "d_mnpio", nullable = true)
    private String d_mnpio;
    @Column(name = "d_estado", nullable = true)
    private String d_estado;
    @Column(name = "d_ciudad", nullable = true)
    private String d_ciudad;
    @Column(name = "d_CP", nullable = true)
    private String d_CP;
    @Column(name = "c_estado", nullable = true)
    private String c_estado;
    @Column(name = "c_oficina", nullable = true)
    private String c_oficina;
    @Column(name = "c_CP", nullable = true)
    private String c_CP;
    @Column(name = "c_tipo_asenta", nullable = true)
    private String c_tipo_asenta;
    @Column(name = "c_mnpio", nullable = true)
    private String c_mnpio;
    @Column(name = "id_asenta_cpcons", nullable = true)
    private String id_asenta_cpcons;
    @Column(name = "d_zona", nullable = true)
    private String d_zona;    
    @Column(name = "c_cve_ciudad", nullable = true)
